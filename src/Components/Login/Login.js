...
function Login() {
  ...
  let { resetPasswordResponseData, otpResSuccess, loading } =
        ...
        <Paper elevation={5} className="paper">
          ...
          <Grid>
            ...
            {resetPasswordResponseData ? (
              <Alert severity="success">{resetPasswordResponseData}</Alert>
            ) : null}

            {otpResSuccess ? (
              <Alert severity="success">{otpResSuccess}</Alert>
            ) : null}
            ...
            <form onSubmit={emailValidation} noValidate>
              ...
              >
                <Link
                  ...
                  style={{ textDecoration: "none", color: "#0033cc" }}
                >
                  Forgot password?
                </Link>
              </Typography>
